...
public class C04_DropDownMenu {
   ...
   */
    ...
    public void test02() throws InterruptedException {
        ...
        select.selectByVisibleText("Books");//goruner texte gore aratir
        // select.selectByIndex(5);
        // select.selectByValue("search-alias=stripbooks-intl-ship");//text ile value farkli oladabilir olmayada bilir kisiden kisiye gorede degisebilir
