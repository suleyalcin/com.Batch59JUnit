...
public class C01_handleWindows {
    ...
    public void test01(){
        ...
        driver.switchTo().newWindow(WindowType.TAB);//driverimiz yeni olusan taba gecti ama simdilik yeni tabimiz bos
        /*
         ...
         */
        driver.get("https://www.amazon.com");//amazona gittik
        driver.findElement(By.id("twotabsearchtextbox")).sendKeys("Nutella" + Keys.ENTER);//nutella icin arama yaptik
        driver.findElement(By.xpath("(//div[@class='a-section aok-relative s-image-square-aspect'])[1]")).click();//ilk urun icin click yaptik
        ...
        System.out.println("Yeni tabda acilan Urun title'i : "+ urunTitleElementi.getText());
        System.out.println("Yeni Tab Url :"+driver.getCurrentUrl());

        // ilk sayfaya gecip url'i yazdiralim
        driver.switchTo().window(ilkSayfaHandleDegeri);
        System.out.println("Eski Tab Url : "+driver.getCurrentUrl());
